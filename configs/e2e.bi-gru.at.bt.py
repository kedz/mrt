...
def main():
    parser = argparse.ArgumentParser(
        "Train E2E transformer model (ls=aligned training, da=base+templates)")
    ...
    parser.add_argument("--max-epochs", default=125, type=int,
    ...
    trainer = setup_trainer(model, args.opt, args.lr, args.wd, args.ls, 
                            ...
                            lambda: f"E2E/bi-gru/at/base+templates/{args.seed}")
